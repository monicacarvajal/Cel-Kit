...
const productosSchema=mongoose.Schema({
    nombre:{
        ...
        trim:true,
        maxLength:[120,"El nombre del producto no debe exceder los 120 caractares."]
    },
    precio:{
        type: Number,
    ...
    descripcion:{
        type:String,
        required:[true,"Por favor registre una descrpcion para el producto."]
    },
    calificacion:{
        type: Number,
        default: 0
    ...
    categoria:{
        ...
        enum:{
            values:[
                "Cargador de pared para celulares",
    ...
    vendedor:{
        type:String,
        required:[true,"Pro favor registre el vdendor de producto"]
    },
    inventario:{
        type: Number,
